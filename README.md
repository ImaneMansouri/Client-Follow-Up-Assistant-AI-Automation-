...
As a project manager, I already track projects and tasks using pm tools. What those tools don't do is watch my inbox and tell me which specific clients went silent. That gap was the thing I was doing by hand every week, so that's the thing I automated.
